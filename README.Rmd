...
It can already be used for making video data visualisations, but sooner or later it will probably have a dedicated vignette and some more functions to make this easier.
...
You can set any of them giving them as a list to `hue_set_state()`, e.g. like this:
